...
export function OthersItems() {
  ...
  return (
    <div className="h-svh flex flex-col bg-white">
      <div className="relative bg-amber-600 px-4 pt-4 pb-4">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-2 text-amber-100 text-sm font-medium bg-white/15 backdrop-blur-sm px-3 py-1.5">
            {(() => {
      ...
      <div className="relative flex-1 px-4 py-4 overflow-y-auto space-y-4 pb-20">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2.5 bg-white/90 backdrop-blur-sm border border-amber-200/50 text-neutral-800 placeholder:text-neutral-400 text-sm focus:outline-none focus:border-amber-500 focus:ring-2 focus:ring-amber-500/20 transition-all shadow-sm"
          />
        </div>
          ...
          <>
            {activeTodos.length > 0 && (
              <div className="space-y-2">
                <div className="flex items-center gap-2 px-1">
                  <div className="p-1.5 bg-amber-600">
                ...
                <div className="space-y-2">
                  {activeTodos.map((todo) => (
                    <div
                      key={todo.id}
                      className="group relative flex items-center gap-3 bg-white pl-4 pr-3 py-3 shadow-sm border border-neutral-200/60 hover:shadow-md hover:border-amber-300 hover:-translate-y-0.5 transition-all duration-200 overflow-hidden"
                    >
            ...
            {filteredTodos.length === 0 && (
              <div className="text-center py-16">
                <div className="inline-flex p-4 bg-amber-50 mb-3">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-neutral-200 px-4 py-3">
        ...
        >
          <input
            ...
            className="flex-1 px-3 py-2.5 bg-white/90 backdrop-blur-sm border border-amber-200/50 text-neutral-800 placeholder:text-neutral-400 text-sm focus:outline-none focus:border-amber-500 focus:ring-2 focus:ring-amber-500/20 transition-all shadow-sm"
          />
          <button
            type="submit"
            className="px-3 py-2.5 bg-amber-600 text-white hover:bg-amber-500 transition-all shadow-md"
          >
