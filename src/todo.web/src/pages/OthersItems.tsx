...
import { ArrowLeft, Plus, Search, Trash2, CheckCircle2, Circle, Calendar, MoreHorizontal, X, AlertCircle } from "lucide-react"
          ...
          <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
            ...
            <div className="min-w-0">
              <div className="flex items-center gap-2 sm:gap-3 mb-1 sm:mb-2">
                ...
                <h1 className="text-2xl sm:text-3xl font-bold text-white truncate">Others</h1>
              </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-4 sm:py-8 space-y-4 sm:space-y-6">
          ...
          <div className="flex gap-2 sm:gap-3 flex-col sm:flex-row">
            <div className="relative flex-1">
              ...
              <Input
                type="text"
                placeholder="Search miscellaneous tasks..."
                value={searchQuery}
            ...
            <>
              ...
              {activeTodos.length === 0 && completedTodos.length === 0 && (
                <div className="text-center py-16">
                  ...
                  <p className="text-sm text-slate-500 mt-1">Add whatever doesn't fit elsewhere</p>
                </div>
              )}
            </>
          )}
