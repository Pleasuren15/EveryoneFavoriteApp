      ...
      <div className="relative flex-1 px-4 py-4 overflow-y-auto space-y-4">
        ...
        {!loading && filteredTodos.length === 0 && (
          <div className="text-center py-12">
            <Briefcase className="w-12 h-12 text-powder-blush-300 mx-auto mb-3" />
            <p className="text-taupe-500 text-sm">No work items</p>
            <p className="text-taupe-400 text-xs mt-1">Add a task to keep things moving</p>
          </div>
        )}
        </>
        )}
