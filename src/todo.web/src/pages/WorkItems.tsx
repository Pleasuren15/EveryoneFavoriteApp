...
import { ArrowLeft, Plus, Search, Trash2, CheckCircle2, Circle, Calendar, Briefcase, X, AlertCircle } from "lucide-react"
          ...
          <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
            ...
            <div className="min-w-0">
              <div className="flex items-center gap-2 sm:gap-3 mb-1 sm:mb-2">
                ...
                <h1 className="text-2xl sm:text-3xl font-bold text-white truncate">Work</h1>
              </div>
            ...
            <>
              ...
              {activeTodos.length === 0 && completedTodos.length === 0 && (
                <div className="text-center py-16">
                  ...
                  <p className="text-slate-300 font-medium">No work tasks yet</p>
                  <p className="text-sm text-slate-500 mt-1">Add a task to keep things moving</p>
                </div>
              )}
            </>
          )}
