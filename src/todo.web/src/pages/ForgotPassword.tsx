  ...
  return (
    <div className="min-h-svh bg-taupe-50 relative overflow-hidden flex items-center justify-center">
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-icy-blue-200 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob"></div>
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-cornflower-blue-200 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob animation-delay-2000"></div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-powder-blush-200 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob animation-delay-4000"></div>
      </div>
        ...
        <div className="bg-white shadow-2xl overflow-hidden">
          ...
          <div className="px-8 md:px-10 py-10">
            <div className="flex flex-col items-center mb-10">
              ...
              <p className="text-taupe-500 text-base">Reset your password</p>
            </div>
